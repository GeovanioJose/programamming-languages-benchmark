...
#header
echo timestamp,total,psys,dram,cpu_temp > out/mendelbrot_out.csv
...
do
    ...
    /usr/bin/time -ao out/runtime.csv -f "%e,%P,%M" python3 -OO mandelbrot.python3-7.py 16000
    ...
    echo $timestamp,$total,$psys,$dram,$cpu_temp_now >> out/mendelbrot_out.csv
done
