...
#header
echo timestamp,total,psys,dram,cpu_temp > out/binarytrees_out.csv
...
do
    ...
    /usr/bin/time -ao out/runtime.csv -f "%e,%P,%M" python3 -OO binarytrees.python3-4.py 21
    ...
    echo $timestamp,$total,$psys,$dram,$cpu_temp_now >> out/binarytrees_out.csv
done
