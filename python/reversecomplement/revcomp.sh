...
#header
echo timestamp,total,psys,dram,cpu_temp > out/revcomp_out.csv
...
do
    ...
    /usr/bin/time -ao out/runtime.csv -f "%e,%P,%M" python3 -OO revcomp.python3-5.py 0 < ../../fasta-output.txt
    ...
    echo $timestamp,$total,$psys,$dram,$cpu_temp_now >> out/revcomp_out.csv
done
