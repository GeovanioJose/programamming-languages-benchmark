...
#header
echo timestamp,total,psys,dram,cpu_temp > out/spectralnorm_out.csv
...
do
    ...
    /usr/bin/time -ao out/runtime.csv -f "%e,%P,%M" python3 -OO spectralnorm.python3-8.py 5500
    ...
    echo $timestamp,$total,$psys,$dram,$cpu_temp_now >> out/spectralnorm_out.csv
done
