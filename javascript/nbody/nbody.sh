...
#header
echo timestamp,total,psys,dram,cpu_temp > out/nbody_out.csv
...
do
    ...
    /usr/bin/time -ao out/runtime.csv -f "%e,%P,%M" node nbody.node-6.js 50000000
    ...
    echo $timestamp,$total,$psys,$dram,$cpu_temp_now >> out/nbody_out.csv
done
